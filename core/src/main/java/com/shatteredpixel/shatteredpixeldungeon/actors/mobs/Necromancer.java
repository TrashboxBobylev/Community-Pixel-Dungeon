...
public class Necromancer extends Mob {
	...
	private class Hunting extends Mob.Hunting{
		...
		public boolean act(boolean enemyInFOV, boolean justAlerted) {
			...
			if (enemySeen && Dungeon.level.distance(pos, enemy.pos) <= 4 && mySkeleton == null && buff(Silencing.Effect.class) == null){
			...
			} else if (enemySeen && mySkeleton != null && buff(Silencing.Effect.class) == null){
