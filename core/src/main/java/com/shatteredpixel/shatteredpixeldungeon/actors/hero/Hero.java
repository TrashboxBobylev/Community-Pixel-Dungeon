...
public class Hero extends Char {
	...
	public int attackProc( final Char enemy, int damage ) {
		...
		if (buff(LeanyElixir.Lean.class) != null){
			damage *= 2;
		}
	...
	public void earnExp( int exp, Class source ) {
		...
		NecklaceOfIce.necklaceRecharge necklaceRecharge = buff(NecklaceOfIce.necklaceRecharge.class);
		if (necklaceRecharge != null) necklaceRecharge.gainExp(exp);
	...
	public boolean add( Buff buff ) {
		...
		if (sprite != null && added) {
			...
			if (buff instanceof Paralysis || buff instanceof VertigoLike) {
				interrupt();
			}
	...
	public void die( Object cause ) {
		...
		if (ankh != null && !(cause instanceof RatKing.RatKingCurse)) {
			...
			WndResurrectExplorer.instance = new Object();
			Game.runOnRenderThread(new Callback() {
				@Override
				public void call() {
					GameScene.show( new WndResurrectExplorer(cause) );
				}
			});
