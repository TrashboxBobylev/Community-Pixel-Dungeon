...
public class ItemSpriteSheet {
	...
	public static final int REPAIRED_RAPIER = MISC_CONSUMABLE +23;
	...
	static{
		...
		assignItemRect(REPAIRED_RAPIER, 13, 14);
	}
	...
	public static final int CROSS_BOMB      = BOMBS+12;
	...
	static{
		...
		assignItemRect(CROSS_BOMB,      11, 14);
	}
	...
	public static final int WAKIZASHI       = WEP_TIER4-1;
	static{
		...
		assignItemRect(WAKIZASHI,       12, 12);
	}
    ...
    public static final int ARTIFACE_NECKLACE   = ARTIFACTS+24;
	static{
		...
		assignItemRect(ARTIFACE_NECKLACE,   15, 16);
	}

	private static final int TRINKETS        =                               xy(10, 17);  //24 slots
	...
	public static final int BROKEN_TREASURE = TRINKETS+15;
	static{
		...
		assignItemRect(BROKEN_TREASURE, 16, 14);
	}
	...
	public static final int BREW_FROSTFIRE  = BREWS+6;
	...
	public static final int ELIXIR_LEAN     = ELIXIRS+8;
	static{
	...
	public static final int RNG_MANIPULATOR = SPELLS+9;
	...
	static{
		...
		assignItemRect(RNG_MANIPULATOR, 12, 13);
