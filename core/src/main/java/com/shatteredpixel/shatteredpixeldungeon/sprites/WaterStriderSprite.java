...
public class WaterStriderSprite extends MobSprite {

	public WaterStriderSprite() {
		super();

		perspectiveRaise = 0f;

		texture( Assets.Sprites.WATER_STRIDER );
	...
	public void zap( int cell ) {
		...
		MagicMissile.boltFromChar( parent,
				MagicMissile.SPECK + Speck.STORM,
				this,
				cell,
				new Callback() {
					@Override
					public void call() {
						((WaterStrider)ch).shootWeb();
					}
				} );
