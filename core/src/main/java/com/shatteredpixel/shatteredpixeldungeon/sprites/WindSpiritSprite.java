...
public class WindSpiritSprite extends MobSprite {

	private TorchHalo light;

	public WindSpiritSprite() {
		super();

        texture( Assets.Sprites.WIND_SPIRIT );
		...
		die.frames( frames, 6, 7, 8, 9, 10, 11, 12, 11);
