...
//			btnNews.setRect(btnRankings.right()+2, btnRankings.top(), btnRankings.width(), BTN_HEIGHT);
			btnSettings.setRect(btnPlay.left(), btnBadges.bottom()+GAP, btnRankings.width(), BTN_HEIGHT);
			btnChanges.setRect(btnSettings.right()+2, btnBadges.bottom() + GAP, btnRankings.width(), BTN_HEIGHT);
			btnAbout.setRect(btnPlay.left(), btnSettings.bottom() + GAP, btnRankings.width()*2, BTN_HEIGHT);
		} else {
...
//			btnNews.setRect(btnRankings.left(), btnRankings.bottom()+ GAP, btnRankings.width(), BTN_HEIGHT);
			btnChanges.setRect(btnPlay.left(), btnBadges.bottom()+GAP, btnPlay.width(), BTN_HEIGHT);
			btnSettings.setRect(btnPlay.left(), btnChanges.bottom()+GAP, btnRankings.width(), BTN_HEIGHT);
	...
	private static class SupportButton extends StyledButton{
		...
		public SupportButton( Chrome.Type type, String label ){
			super(type, label);
			icon(Icons.get(Icons.COMMUNITY));
			textColor(0x25CA1F);
		}
