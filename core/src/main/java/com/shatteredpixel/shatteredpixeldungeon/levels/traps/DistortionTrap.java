...
public class DistortionTrap extends Trap{
	...
	private static final ArrayList<Class<?extends Mob>> RARE = new ArrayList<>(Arrays.asList(
			...
			Bandit.class, FailedDefender.class,
		...
		for (Integer point : respawnPoints) {
			...
			switch (summoned){
				...
				case 2:
					...
					break;
				case 4:
					if (Feature.FAILED_DEFENDER.enabled){
						 if (!RARE.contains(FailedDefender.class))
							 RARE.add(FailedDefender.class);
					} else {
						RARE.remove(FailedDefender.class);
					}
