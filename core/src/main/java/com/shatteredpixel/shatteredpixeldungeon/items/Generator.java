...
public class Generator {
	...
	public enum Category {
		...
		static {
			...
			subOrderings.put(Scroll.class, new ArrayList<>(Arrays.asList(Scroll.class, ExoticScroll.class, Spell.class, ArcaneResin.class, GemstoneDust.class)));
		}
	...
	public static void reset(Category cat){
		...
		//disable spawning of disabled items
	...
	public static void restoreFromBundle(Bundle bundle) {
		...
		for (Category cat : Category.values()){
			if (bundle.contains(cat.name().toLowerCase() + CATEGORY_PROBS)){
				...
				//turn probs for disabled items off
				ArrayList<Feature> disabledFeatures = new ArrayList<>();
				for (Feature feature: Feature.values()){
					if (!feature.enabled)
						disabledFeatures.add(feature);
